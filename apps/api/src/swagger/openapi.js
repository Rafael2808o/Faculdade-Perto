export const openapi = {
  ...
  paths:{
    ...
    '/me/plan/{id}':{delete:{tags:['Conta'],summary:'Remove um item do Meu Plano',security:[{bearerAuth:[]}],parameters:[{name:'id',in:'path',required:true,schema:{type:'integer'}}],responses:{204:{description:'Removido'},404:{description:'Item não encontrado'}}}},
