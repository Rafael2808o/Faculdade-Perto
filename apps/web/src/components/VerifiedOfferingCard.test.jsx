...
const offering={
  ...
  campus:{name:'Unidade Andradina — Centro',locationStatus:'confirmado',address:{street:'Rua Rodrigues Alves',number:'756',neighborhood:'Centro'}},
...
describe('oferta atual verificada',()=>{
  it('mostra endereço, fonte e rota de detalhe sem confundir com o Censo',()=>{
    ...
    expect(screen.getByText('Curso em fonte oficial')).toBeTruthy();
